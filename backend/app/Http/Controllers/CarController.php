...
class CarController extends Controller {
	public function append(Request $request) {
		...
		Redis::hmset($key . "_" . $mealId, 'meal_id', $mealId, 'shop_id', $meal->shop_id, 'quantity', $number, 'note', $note);
	...
	public function index(Request $request) {
		...
		foreach ($keys as $orderId) {
			...
			array_push($ans, ['meal_id' => Redis::hget($temp_key, 'meal_id'),
				'quantity' => Redis::hget($temp_key, 'quantity'), 'shop_id' => Redis::hget($temp_key, 'shop_id'),
